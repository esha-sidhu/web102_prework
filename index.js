...
const descriptionText = `
  A total of ${raisedCard.innerText} has been raised for ${gamesCard.innerText} games. 
  Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? ' remains' : 's remain'} unfunded. 
